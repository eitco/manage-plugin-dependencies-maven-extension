...
File effectivePom = new File(new File("$basedir"), 'database/target/effective-pom.xml')
...
assert liquibasePluginDependency.':version'.text() == '42.7.3'
assert jooqMavenPluginDependency.':artifactId'.text() == 'postgresql'
assert jooqMavenPluginDependency.':version'.text() == '42.7.3'
